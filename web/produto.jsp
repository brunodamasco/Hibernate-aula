                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="_cadastroControle?cmd=salvar" method="post" novalidate="novalidate">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="qtde" name="qtde" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                                </div>
                                                <div class="form-group">
                                                    <label for="compra" class="control-label mb-1">Preço de compra</label>
                                                    <input id="compra" name="compra" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                                </div>
                                                <div class="form-group">
                                                    <label for="venda" class="control-label mb-1">Preço de venda</label>
                                                    <input id="venda" name="venda" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                                </div>
                                                <div class="form-group">
                                                    <label for="descricao" class="control-label mb-1">Descrição</label>
                                                    <textarea id="descricao" name="descricao" class="form-control" aria-required="true" area-invalid="false">
                                                    </textarea>
                                                </div>
                                                <div>
